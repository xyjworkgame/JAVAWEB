...
<%
    ...
    custs.add(new Customers(1, "AAA")); //index: 0
    custs.add(new Customers(2, "BBB")); //1
    custs.add(new Customers(3, "CCC"));
    custs.add(new Customers(4, "DDD")); //3
    custs.add(new Customers(5, "EEE"));
    custs.add(new Customers(6, "FFF")); //5
...
<!-- 遍历 Map -->
<%
    Map<String, Customers> custMap = new HashMap<String, Customers>();
    custMap.put("a", new Customers(1, "AAA")); //index: 0
    custMap.put("b", new Customers(2, "BBB")); //index: 0
    custMap.put("c", new Customers(3, "CCC")); //index: 0
    custMap.put("d", new Customers(4, "DDD")); //index: 0
    custMap.put("e", new Customers(5, "EEE")); //index: 0
    custMap.put("f", new Customers(6, "FFF")); //index: 0
