    ...
    <span><img src="images/leftico01.png" /></span>个人信息
	   ...
	   <dd>
	    ...
	    <span><img src="images/leftico01.png" /></span>管理信息
	    	...
	    	<ul class="menuson">
	        <li><cite></cite><a href="user?oper=show&pageNum=1&pageSize=10" target="rightFrame">查看用户信息--非ajax</a><i></i></li>
	        <li><cite></cite><a href="user/ajaxUser.jsp" target="rightFrame">查看用户信息--ajax</a><i></i></li>
	        </ul>    
	    </dd>
    </dl>
</body>
